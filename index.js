...
const tweetsUrl = `${twitterUrl}recent?query=from:ItsTradeNation&tweet.fields=created_at&expansions=author_id&user.fields=created_at,profile_image_url&media.fields=preview_image_url`;
